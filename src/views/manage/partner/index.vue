    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="250px">
        <template #default="scope">
          ...
          <el-button link type="primary" @click="getPartnerInfo(scope.row)" v-hasPermi="['manage:partner:export']">查看详情</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="partnerRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="分成比例" prop="profitRatio">
          <el-input v-model="form.profitRatio" placeholder="请输入分成比例" ></el-input>
        </el-form-item>
...
function resetPwd(row) {
  ...
  proxy.$modal.confirm('你确定要重置该合作商密码吗').then(function() {
    return resetPartnerPassword(_ids);
  }).then(() => {
